...
public record SimpleTopologyCreateRequest(
        ...
        @SuppressWarnings({"java:S5843", "java:S5998"}) @NotEmpty @Pattern(regexp = "^\\s*($|#|\\w+\\s*=|(\\?|\\*|"
                ...
                + "\\s+(\\?|\\*|(?:[0-5]?\\d)(?:(?:-|\\/|\\,)(?:[0-5]?\\d))?(?:,(?:[0-5]?\\d)(?:(?:-|\\/|\\,)"
                + "(?:[0-5]?\\d))?)*)\\s+(\\?|\\*|(?:[01]?\\d|2[0-3])(?:(?:-|\\/|\\,)(?:[01]?\\d|2[0-3]))?(?:,"
                + "(?:[01]?\\d|2[0-3])(?:(?:-|\\/|\\,)(?:[01]?\\d|2[0-3]))?)*)\\s+(\\?|\\*|(?:0?[1-9]|[12]\\d|3[01])"
                + "(?:(?:-|\\/|\\,)(?:0?[1-9]|[12]\\d|3[01]))?(?:,(?:0?[1-9]|[12]\\d|3[01])(?:(?:-|\\/|\\,)"
                + "(?:0?[1-9]|[12]\\d|3[01]))?)*)\\s+(\\?|\\*|(?:[1-9]|1[012])(?:(?:-|\\/|\\,)(?:[1-9]|1[012]))?"
                ...
                + "(?:|\\d{4})(?:(?:-|\\/|\\,)(?:|\\d{4}))?(?:,(?:|\\d{4})(?:(?:-|\\/|\\,)(?:|\\d{4}))?)*))$",
                message = "Invalid cron, please check http://www.quartz-scheduler.org/documentation/quartz-2.3"
                        + ".0/tutorials/crontrigger.html for help") String cron,
        @SuppressWarnings({"java:S5843", "java:S5998"}) @NotEmpty @Pattern(regexp = "^(?:(?=[^:\\/]{4,253})(?!-)"
